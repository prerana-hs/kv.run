...
from text_generation_server.models.custom_modeling.flashinfer_chatglm_modeling import (
    ChatGLM3Config, FlashChatGLMForCausalLM
)
...
class FlashinferChatGLM(FlashinferLM):
    def __init__(
        ...
        chatglmConfig = ChatGLM3Config.from_pretrained(
